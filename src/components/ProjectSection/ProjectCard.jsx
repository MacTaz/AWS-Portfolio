  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-5 md:gap-10 lg:gap-20 w-full">
      <div className="flex flex-col items-center md:items-start justify-center flex-1">
        ...
        <p className="font-inter text-xl font-bold text-center md:text-left w-full">
          {title}
        </p>
        ...
        {githubUrl && (
          <a
            ...
            className="mt-1 opacity-70 hover:opacity-100 hover:-translate-y-0.5 transition-all duration-200"
          >
